...
<body>
  ...
  <div id="loginForm">
    <form method="post">
      ...
      <input id="txtemailaddorusername" name="txtemailaddorusername" class="txtInput" type="text" placeholder="abcd@email.com or accord.mod.12" required />
      <label for="txtpassword">Password</label>
      <input id="txtpassword" name="txtpassword" class="txtInput" type="text" placeholder="********" required />
